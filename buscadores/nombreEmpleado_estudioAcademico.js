function autocompletar() {
	const inputPaciente = document.querySelector('#cod_empleado');
	let indexFocus = -1;
	...
	inputPaciente.addEventListener('input', function () {
		...
		httpRequest(serverTi + 'buscadores/nombreEmpleado_estudioAcademicoControlador.php?text=' + nombrePaciente, function () {
