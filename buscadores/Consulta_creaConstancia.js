function autocompletar(){
	const inputPaciente = document.querySelector('#codigo_diagnostico_reg');
	let indexFocus=-1;
	...
	httpRequest(serverTi+'buscadores/Consulta_creaConstanciaControlador.php/?codigo_diagnostico_reg='+nombrePaciente, function(){
...
/* function ajustarTamañoTextBox(){
	...
	var cajaTextoEjemplo = document.getElementById("dosis_medicamento");
