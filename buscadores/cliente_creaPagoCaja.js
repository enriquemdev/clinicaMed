//Se alimenta del contnrolador de CodDoctor_creaCita
function autocompletar(){
	const inputPaciente = document.querySelector('#cliente_pago_reg');
	let indexFocus=-1;
...
//http://localhost/ClinicaMed/ local
	httpRequest(serverTi+'buscadores/cliente_creaPagoCajaControlador.php?cliente_pago_reg='+nombrePaciente, function(){
...
// 	var cajaTextoEjemplo = document.getElementById("codigo_consultorio");
