function autocompletar() {
	const inputPaciente = document.querySelector('#receta_examen');
	let indexFocus = -1;
	...
	inputPaciente.addEventListener('input', function () {
		...
		httpRequest(serverTi + 'buscadores/RecetaExamen_examenControlador.php?text=' + nombrePaciente, function () {
