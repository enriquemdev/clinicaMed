...
function autocompletar(){
	const inputPaciente = document.querySelector('#cita_doctor_reg');
	let indexFocus=-1;
...
//http://localhost/ClinicaMed/ local
	httpRequest(serverTi+'buscadores/codDoctor_creaCitaControlador.php?cita_doctor_reg='+nombrePaciente, function(){
