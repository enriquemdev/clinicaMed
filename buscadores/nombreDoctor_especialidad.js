function autocompletar() {
	const inputPaciente = document.querySelector('#codigo_dog_especialidad');
	let indexFocus = -1;
	...
	inputPaciente.addEventListener('input', function () {
		...
		httpRequest(serverTi + 'buscadores/nombreDoctor_especialidadControlador.php?text=' + nombrePaciente, function () {
