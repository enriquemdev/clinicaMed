function autocompletar() {
	...
	inputPaciente.addEventListener('input', function () {
		...
		let lab = $('#item_laboratorio').val().split("__")[1];

		//CONEXION A BD
		var serverTi = document.getElementById("serverTi").innerText;//Este elemento esta antes de la llamada al scrpt en el html
		httpRequest(serverTi + 'buscadores/nombreProveedor_creaCompraControlador.php?proveedor_reg=' + nombrePaciente + '&med=' + med + '&lab=' + lab, function () {
