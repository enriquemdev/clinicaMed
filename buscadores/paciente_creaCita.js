function autocompletar(){
	const inputPaciente = document.querySelector('#cita_paciente_reg');
	let indexFocus=-1;
...
//http://localhost/ClinicaMed/ local
	httpRequest(serverTi+'buscadores/paciente_creaCitaControlador.php?cita_paciente_reg='+nombrePaciente, function(){
