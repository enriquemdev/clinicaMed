//Usa el controlador de codDoctor Crea Receta Medica
function autocompletar(){
	const inputPaciente = document.querySelector('#codigo_consulta_reg');
	let indexFocus=-1;
	...
	httpRequest(serverTi+'buscadores/Consulta_creaDiagnosticoControlador.php/?codigo_consulta_reg='+nombrePaciente, function(){
...
// 	var cajaTextoEjemplo = document.getElementById("sintoma_reg");
// 	var cajaTextoCambiar = document.getElementById("codigo_consulta_reg");
