function autocompletar() {
	const inputPaciente = document.querySelector('#especialista_examen');
	let indexFocus = -1;
	...
	inputPaciente.addEventListener('input', function () {
		...
		httpRequest(serverTi + 'buscadores/NombreEspecialista_examenControlador.php?text=' + nombrePaciente, function () {
