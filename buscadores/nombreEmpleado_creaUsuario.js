function autocompletar(){
	const inputPaciente = document.querySelector('#usuario_empleado_reg');
	let indexFocus=-1;
	...
	httpRequest(serverTi+'buscadores/nombreEmpleado_creaUsuarioControlador.php?usuario_empleado_reg='+nombrePaciente, function(){
...
function ajustarTamañoTextBox(){
	...
	var cajaTextoNombreUsuario = document.getElementById("usuario_usuario");
	var cajaTextoEmpleado = document.getElementById("usuario_empleado_reg");

	cajaTextoEmpleado.style.width = cajaTextoNombreUsuario.offsetWidth+"px";
