...
if (isset($_POST['input']) ) {
    ...
    $query = "SELECT * FROM tblpersona WHERE Nombres like '{$input}%'";
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <th><button type="button" class="btn btn-raised btn-info btn-sm" onclick="rellenarData('<?php echo $row['Nombres']?>',
                        '<?php echo $row['Apellidos']?>','<?php echo $row['Cedula']?>','<?php echo $row['Genero']?>','<?php echo $row['Fecha_de_nacimiento']?>',
                        '<?php echo $row['Estado_civil']?>','<?php echo $row['Direccion']?>','<?php echo $row['Telefono']?>','<?php echo $row['Email']?>')" 
