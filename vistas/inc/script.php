<!--=============================================
	...
	<!--Aquí tocó luis again -->

	<script src="<?php echo SERVERURL; ?>vistas/js/Popover.js"></script>
	<script src="<?php echo SERVERURL; ?>vistas/js/formato.js"></script>
	<script src="<?php echo SERVERURL; ?>Vistas/js/utilidades.js"></script>
	<script src="<?php echo SERVERURL; ?>Vistas/js/completadores/completadorPersona.js"></script>

	<!--Para dashboards by luis -->
	<script src="<?php echo SERVERURL; ?>Vistas/js/dashboards/dashboards.js"></script>
	<script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
	<!--Para agregar scripts de funcionalidades -->