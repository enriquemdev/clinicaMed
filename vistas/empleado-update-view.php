...
<?php 
	...
	?>
			...
			<div class="container-fluid">
				...
				<input type="hidden" name="codijillo" value="<?php echo $campos['CodPersona'] ?>">
					<fieldset>
						...
						<div class="container-fluid">
							<div class="row">
								...
								<div class="col-12 col-md-6">
									<div class="form-group">
										<label for="empleado_apellidos" class="bmd-label-floating">APELLIDOS</label>
								...
								<div class="col-12 col-md-6">
									<div class="form-group">
										...
										<input type="text" pattern="[0-9-]{9,20}" class="form-control" name="empleado_inss_up" id="empleado_inss" maxlength="10" required="" value="<?php echo $campos['INSS'] ?>">
									</div>
								</div>
								<div class="col-12 col-md-6">
									<div class="form-group">
										<label for="empleado_cedula" class="bmd-label-floating">CEDULA</label>
								...
								<div class="col-12 col-md-6">
										...
										<label for="item_genero" class="bmd-label-floating">GENERO</label>
								...
								<div class="col-12 col-md-6">
									<div class="form-group">
										<label for="empleado_nacio" class="bmd-label-static" >FECHA DE NACIMIENTO </label>
								...
								<div class="col-12 col-md-6">
									<label for="item_estado_civil" class="bmd-label-floating">ESTADO CIVIL</label>
								...
								<div class="col-12 col-md-6">
									<div class="form-group">
										...
										<input type="text" pattern="[0-9#- ]{1,150}" class="form-control" name="empleado_telefono_up" id="empleado_cedula" maxlength="14" required="" value="<?php echo $campos['Telefono'] ?>">
									</div>
								</div>
