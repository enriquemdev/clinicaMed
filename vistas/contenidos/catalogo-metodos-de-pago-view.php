						...
						<div class="container-fluid">
							...
							<div class="col-12 col-md-6">
									<div class="form-group">
										<label for="nombre_metodoPago_reg" class="bmd-label-floating">NOMBRE DE METODO DE PAGO</label>
										<input type="text" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,#\- ]{3,60}" class="form-control" name="nombre_metodoPago_reg" id="nombre_metodoPago_reg" maxlength="60" required>
                                ...
                                <div class="col-12 col-md-6">
									<div class="form-group">
										<label for="descripcion_metodoPago_reg" class="bmd-label-floating">DESCRIPCION DE METODO DE PAGO</label>
										<input type="text" class="form-control" name="descripcion_metodoPago_reg" id="descripcion_metodoPago_reg" maxlength="255" required>
									</div>
							    </div>
