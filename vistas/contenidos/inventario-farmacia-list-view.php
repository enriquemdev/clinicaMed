...
<div class="full-box page-header">
	<h3 class="text-left">
		<i class="fas fa-clipboard-list fa-fw"></i> &nbsp; INVENTARIO
	</h3>
	<p class="text-justify">
		Lista de medicamentos en inventario
	</p>
</div>
...
<div class="container-fluid">
	<ul class="full-box list-unstyled page-nav-tabs">
		...
		if ($ver == true) { ?>
			<li>
				<a class="active" href="<?php echo SERVERURL; ?>inventario-farmacia-list/"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA INVENTARIO</a>
			</li>
...
<div class="container-fluid">
	...
	echo $ins_inventario_farmacia->paginador_inventario_farmacia_controlador($pagina[1], 15, $_SESSION['privilegio_spm'], $_SESSION['id_spm'], $pagina[0], "");
