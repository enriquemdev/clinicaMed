...
<div class="full-box page-header">
	<h3 class="text-left">
		<i class="fas fa-clipboard-list fa-fw"></i> &nbsp; MERCANCIA NO INEVNTARIADA
	</h3>
	<p class="text-justify">
		Lista de medicamentos esperando por inventariar
	</p>
</div>
...
<div class="container-fluid">
	<ul class="full-box list-unstyled page-nav-tabs">
		...
		if ($agregar == true) { ?>
			<li>
				<a class="active" href="<?php echo SERVERURL; ?>inventario-agregar-lote-farmacia-list/"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; AÑADIR LOTES</a>
			</li>
		<?php } ?>
		<?php
		if ($agregar == true) { ?>
...
<div class="container-fluid">
	...
	echo $ins_inventario_farmacia->paginador_agregar_lote_farmacia_controlador($pagina[1], 15, $_SESSION['privilegio_spm'], $_SESSION['id_spm'], $pagina[0], "");
