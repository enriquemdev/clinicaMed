...
<div class="full-box page-header">
            ...
            <script>
                // Validaciones de input decimales

                var inputsDecimales = document.querySelectorAll(".inputDecimal");
                ...
                for (var inputDecimal of inputsDecimales)
                {   
                    inputDecimal.addEventListener('mouseleave', (event) => {
                    ...
                    inputDecimal.addEventListener('input', (event) => {
                        validar2Decimales(event);
                    });

                    inputDecimal.addEventListener('click', (event) => {
