...
<div class="container-fluid">
	<ul class="full-box list-unstyled page-nav-tabs">
		...
		<?php if ($ver == true) { ?>
			...
			<li>
				<a class="active" href="<?php echo SERVERURL; ?>ventas-farmacia-search/"><i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR VENTA</a>
			</li>
		<?php } ?>
	</ul>
</div>
<!--1 --> <?php
			if (!isset($_SESSION['busqueda_ventas-farmacia']) && empty($_SESSION['busqueda_ventas-farmacia'])) { //se le pone buqueda_ y luego el nombre del modulo
	...
	<div class="container-fluid">
		...
		<form class="form-neon FormularioAjax" action="<?php echo SERVERURL; ?>ajax/buscadorAjax.php" method="POST" data-form="default" autocomplete="off">
			<input type="hidden" name="modulo" value="ventas-farmacia"><!-- input hidden para las busquedas -->
				...
				<div class="row justify-content-md-center">
					<div class="col-12 col-md-6">
						...
						<p class="text-center" style="font-size: 20px;">
							Resultados de la búsqueda: <strong> <?php echo ($_SESSION['busqueda_ventas-farmacia']); ?> </strong>
						</p><!-- ti -->
	...
	<div class="container-fluid">
		<?php
				...
				echo $ins_ventasFarmaciaControlador->paginador_ventas_farmacia_controlador($pagina[1], 15, $_SESSION['privilegio_spm'], $_SESSION['id_spm'], $pagina[0], $_SESSION['busqueda_ventas-farmacia']);
