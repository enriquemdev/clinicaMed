...
<div class="full-box page-header">
	<h3 class="text-left">
		<i class="fas fa-plus fa-fw"></i> &nbsp; AÑADIR FAMILIAR EMPLEADO
	</h3>
	<p class="text-justify">
		Registre nuevo familiar
	</p>
</div>
...
<div class="container-fluid">
	<ul class="full-box list-unstyled page-nav-tabs">
		<li>
			<a class="active" href="<?php echo SERVERURL; ?>familiares-new/"><i class="fas fa-plus fa-fw"></i> &nbsp; AGREGAR FAMILIAR</a>
		</li>
				...
				<div class="row">
					<div class="col-12 col-md-6">
						<div class="form-group">
							...
							<input type="text" pattern="[1-9a-zA-ZáéíóúÁÉÍÓÚ ]{3,50}" class="form-control" name="nombre_familiar_empleado_reg" id="nombre_familiar" maxlength="50" required="">
						</div>
					</div>
					<div class="col-12 col-md-6">
						<div class="form-group">
					...
					<div class="col-12 col-md-6">
						<div class="form-group">
							...
							<input type="text" pattern="[a-zA-Z0-9- ]{16,16}" class="form-control" name="cedula_familiar_empleado_reg" id="cedula_familiar" maxlength="16" required="">
						</div>
					</div>
					<div class="col-12 col-md-6">
						...
						<div class="form-group">
							<div class="form-group">
								...
								<div class="autocompletar">
									<input type="text" class="form-control" name="familiar_de_reg" id="familiar_de" maxlength="50" required="true">
								</div>
							</div>
						</div>
					</div>
...
<script src="<?php echo SERVERURL; ?>buscadores/familiarDe_empleado.js"></script>