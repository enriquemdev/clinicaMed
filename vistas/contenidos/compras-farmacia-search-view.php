...
<div class="full-box page-header">
	<h3 class="text-left">
		<i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR COMPRA
	</h3>
...
<div class="container-fluid">
	<ul class="full-box list-unstyled page-nav-tabs">
		...
		<?php if ($ver == true) { ?>
			...
			<li>
				<a class="active" href="<?php echo SERVERURL; ?>compras-farmacia-search/"><i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR COMPRA</a>
			</li>
		<?php } ?>
	</ul>
</div>
<!--1 --> <?php
			if (!isset($_SESSION['busqueda_compras-farmacia']) && empty($_SESSION['busqueda_compras-farmacia'])) { //se le pone buqueda_ y luego el nombre del modulo
	...
	<div class="container-fluid">
		...
		<form class="form-neon FormularioAjax" action="<?php echo SERVERURL; ?>ajax/buscadorAjax.php" method="POST" data-form="default" autocomplete="off">
			<input type="hidden" name="modulo" value="compras-farmacia"><!-- input hidden para las busquedas -->

			<div class="container-fluid">
				<div class="row justify-content-md-center">
					<div class="col-12 col-md-6">
						<div class="form-group">
							<label for="inputSearch" class="bmd-label-floating">¿Qué compra estas buscando?</label>
				...
				<div class="row justify-content-md-center">
					<div class="col-12 col-md-6">
						...
						<p class="text-center" style="font-size: 20px;">
							Resultados de la búsqueda: <strong> <?php echo ($_SESSION['busqueda_compras-farmacia']); ?> </strong>
						</p><!-- ti -->
	...
	<div class="container-fluid">
		<?php
				...
				echo $ins_comprasFarmaciaControlador->paginador_compras_farmacia_controlador($pagina[1], 15, $_SESSION['privilegio_spm'], $_SESSION['id_spm'], $pagina[0], $_SESSION['busqueda_compras-farmacia']);
