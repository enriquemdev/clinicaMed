...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-10-2022 a las 08:01:30
...
(1, 1, 1, NULL, '2022-09-30 20:51:59'),
(2, 1, 2, NULL, '2022-09-30 20:57:40'),
(3, 1, 1, NULL, '2022-10-02 23:03:29'),
(4, 1, 2, NULL, '2022-10-02 23:08:12'),
(5, 4, 1, NULL, '2022-10-11 05:55:18'),
(6, 4, 2, NULL, '2022-10-11 05:59:53'),
(7, 1, 1, NULL, '2022-10-11 05:59:59'),
(8, 1, 2, NULL, '2022-10-11 06:01:11'),
(9, 1, 1, NULL, '2022-10-11 06:01:14');
...
--
ALTER TABLE `tblaperturacaja`
  MODIFY `idApertura` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT de la tabla `tblasignacionlote`
--
ALTER TABLE `tblasignacionlote`
  MODIFY `idAsignacionLote` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tbldetsolicitudcompra`
  MODIFY `idDetSolicitudCompra` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tblsesion`
  MODIFY `idSesion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `tblsintomasdiagnostico`
  MODIFY `idSintomaDiagnostico` int(11) NOT NULL AUTO_INCREMENT;
